...
//
//	mockgen -destination=/Users/timur_abdurashidov/Desktop/other/vpn/internal/server/handlers/tun/mocks/PeerManager_mock.go -package=mocks . PeerManager
//
...
func (m *MockPeerManager) GetByDedicatedIP(arg0 context.Context, arg1 net.IP) (*server.Peer, error) {
	m.ctrl.T.Helper()
